...
public enum Role{
    ...
    ROLE_GLOBEX_ADMIN("ROLE_GLOBEX_ADMIN",1),ROLE_GLOBEX("ROLE_GLOBEX_USER",2),
    ROLE_PM_ADMIN("ROLE_PM_ADMIN",3),ROLE_PM_USER("ROLE_PM_USER",4),
    ROLE_LM_ADMIN("ROLE_LM_ADMIN",5),ROLE_LM_USER("ROLE_LM_USER",6),
